...
public class B_Switch {
	// switch 문
	// if문의 부분집합 (일부분)으로 if문은 조건식으로 범위를 지정할 수 있지만,
	 ...
	 * }
	 * 
	 * break : switch문을 멈춰라 라는 의미
	 * */
	
	
	public void example1() {
		// 1~5사이의 정수를 입력받아 1이면 A팀, 2면 B팀...팀부여하고 출력하기
		// 단, 1~5사이의 수가 아니면 "잘못 입력하셨습니다." 출력하기
	...
	public void example2() {
		// 두 수를 입력받고, 연산자(+,-,*,/,%) 중 하나를 입력 받아 연산한 결과를 출력
		// 단, 잘못된 연산자 입력 시 "연산자를 잘못 입력하셨습니다." 출력
		...
		int result  = 0; // int형 변수 result를 선언 및 0으로 초기화
		// int형의 기본값은 0 
		...
		// return : 호출한 곳으로 돌아가라
		//   --> return 코드를 읽는 시점에서 해당 메소드가 종료됨.
		//  (메소드 종료기능으로 사용 가능)
	...
	public void example3() {
		...
		int price = 0;  // 과일의 가격을 저장할 변수 선언 및 초기화
		switch(fruit) {
	...
	public void example4() {
		...
		case 2:
			System.out.println("28 또는 29일"); break;
