...
public class ElectronicsService {
	...
	//오버로딩을 사용해도 되지만 코드 길이가 늘어나서 비효율적
	// -->다형성을 적용 매개변수의 타입을 부모타입으로 하여
	//    자식 객체 주소를 전달 받도록 함.
	public void insert(Electronics e) {  // 매개변수에 다형성 적용
		el[index++] = e;  // 객체 배열에 다형성 적용
		
		// index 번째 el 요소에 전달받은 자식 객체 주소를 추가하고
		// index를 1 증가시킴
	}
	...
	// 각 기기 정보 조회
	//public Desktop selectDasktop(int i) {}
	//public Laptop selectLaptop(int i) {}
	// 전자기기 하나씩의 정보를 반환해야 되는 경우
