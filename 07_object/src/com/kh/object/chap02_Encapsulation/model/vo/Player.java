...
public class Player { // 운동선수를 추상화한 클래스
	...
	// ----- 속성 -----
	// * 캡슐화 원칙 : 클래스의 멤버 변수(필드)에 private을 붙여 외부 직접 접근 차단.
	...
	// 1) 멤버 변수(필드)를 이용한 연산 처리 기능
	// 2) 속성(멤버변수,필드) 외부 간접 접근 기능
	//    --> getter / setter 메소드
	...
	// 외부에서 접근할 수 있도록 public 으로 선언해야 함.
	public String getName() {
		// --> String (반환형) : 메소드 수행 후 반환되는 값의 자료형
		
		// return : 메소드 종료 시 호출한 곳으로 돌려 보내는 값을 작성.
		return name; 
