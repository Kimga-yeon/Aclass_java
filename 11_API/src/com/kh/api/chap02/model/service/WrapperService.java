...
public class WrapperService {
	 ...
	 *     String ("1") <-> int형태 (1) 문자열을 숫자로 바꾸거나 숫자를 문자로 바꿀 수 있음
	 *   
	...
	public void example() {
		...
		//            public static final int byte (객체. = static / BYTES 대문자= final) 
		...
		for(int i=0; i<arr.length; i++) {
			...
			// parseXXX : String 이지만 기본 자료형의 형태를 가지고 있으면 
			// 			    해당 자료형으로 변환  (파싱,parsing) ex) "100" -> 100
		}
