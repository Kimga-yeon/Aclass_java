package com.kh.inherit.chap02.service;
...
public class OverrideService {
	public void example1() {
		...
		// 참조변수를 출력하는 경우에
		// JVM에 의해서 컴파일 단계에서 자동으로 .toString이 추가됨.
		...
		// String 값 비교
		// String.equals()는 두 문자열에서 각 문자들이 
		// 서로 같은지를 판별하도록 오버라이딩이 되어 있음.
		String str1 = "Hello";
		String str2 = "Hello";
		...
		if(book1.equals(book2)) {  // 동등 객체인지 비교
		...
		if(book1.equals(book3)) {  // 동등 객체인지 비교
			System.out.println("같은 책이다");
		}else {
			System.out.println("다른 책이다.");
		}
